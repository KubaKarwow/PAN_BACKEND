...
public class Lnc_rna {
    ...
    @Column(name = "gene_category")
    private String gene_category;
    @Column(name = "lnc_rna_level")
    private String lnc_rna_level;
    ...
    @Column(name = "associated_gene_acc")
    private String associated_gene_acc;
    @Column(name = "associated_gene_name")
    private String associated_gene_name;
    @Column(name = "associated_gene_strand")
    private String associated_gene_strand;
    @Column(name = "associated_gene_start")
    private String associated_gene_start;
    @Column(name = "associated_gene_end")
    private String associated_gene_end;
}
