...
@Setter
@Entity
@Table(name = "differentiation_2")
public class Differentiation2 {
    @Id
    ...
    @Column(name = "\"Pleural metastasis_diff\"", length = Integer.MAX_VALUE)
    private String pleuralMetastasisDiff;
