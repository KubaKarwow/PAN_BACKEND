...
@Setter
@Entity
@Table(name = "stemness_4")
public class Stemness4 {
    @Id
    ...
    @Column(name = "\"Pleural metastasis and Breast-to-Brain metastasis_stem\"", length = Integer.MAX_VALUE)
    private String pleuralMetastasisAndBreastToBrainMetastasisStem;
